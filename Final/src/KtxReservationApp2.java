...
public class KtxReservationApp2 extends JFrame {
	KtxSeat2 ktxseat2=new KtxSeat2();
	...
	private class  MyButtonListener implements ActionListener{
		public void actionPerformed(ActionEvent e) { 
			...
			new Person2(ktxseat2,"p1").start();
			new Person2(ktxseat2,"p2").start();
			new Person2(ktxseat2,"p3").start();
			new Person2(ktxseat2,"p4").start();
			new Person2(ktxseat2,"p5").start();
			new Person2(ktxseat2,"p6").start();
			
			new Person2(ktxseat2,"police1").start();
			new Person2(ktxseat2,"police2").start();
			
			new Person2(ktxseat2,"broker1").start();
			new Person2(ktxseat2,"broker2").start();
